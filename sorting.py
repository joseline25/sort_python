...
class DrawInformation:
    ...
    GRADIENTS = [
        ...
        (255, 105, 180),  # (160, 160, 160),
        (255, 20, 147)  # (192, 192, 192)
    ]

    FONT = pygame.font.SysFont('comicsans', 10)
    LARGE_FONT = pygame.font.SysFont('comicsans', 15)

    # create the visualisation screen and set set size/width
    ...
    # create list of elements to sort with size that ajust to size of the screen
...
def draw(draw_info, algo_name, ascending):
    ...
    controls = draw_info.FONT.render("R or  SPACE - reset the list | S - start sorting the list | A - ascending | D - "
                                     "descending", 1, draw_info.PINK)
    draw_info.window.blit(controls, (draw_info.width / 2 - controls.get_width() / 2, 35))
    sorting = draw_info.FONT.render("I - Insertion Sort | B - Bubble Sort", 1, draw_info.PINK)
...
while run:
    ...
    for event in pygame.event.get():
        ...
        # press space or r on keyboard to reset the list!!
